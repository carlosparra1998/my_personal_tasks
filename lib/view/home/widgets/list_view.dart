            ...
            itemBuilder: (BuildContext context, int index) {
              return Card(
                child: ListTile(
                  ...
                  leading: Checkbox(
                    side: BorderSide(
                      color: (taskViewModel.getTaskList()[index].priorityLevel == 1)
                          ? Colors.red
                          : (taskViewModel.getTaskList()[index].priorityLevel == 2
                              ? Colors.orange
                    ...
                    onChanged: (bool? value) {
                      ...
                      taskViewModel.removeTaskInList(index, taskViewModel.getTaskList()[index].id);
                  ...
                  title: Text(taskViewModel.getTaskList()[index].title),
                  subtitle: Text(taskViewModel.getTaskList()[index].description),
                ),
              );
            },
          )),
